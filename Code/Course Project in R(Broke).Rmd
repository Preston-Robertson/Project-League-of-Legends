...
ggplot(data = dat) +
  geom_point(mapping = aes(x = Duration_mins, y = Kills, color = Win)) +
  geom_point(mapping = aes(x = Duration_mins, y = Deaths, color = Win))
```
...
ggplot(data = dat) +
  geom_point(mapping = aes(x = GoldEarned, y = Deaths, color = Win))

ggplot(data = dat) +
  geom_point(mapping = aes(x = GoldEarned / Duration_mins, y = Deaths / Duration_mins, color = Win))
```
